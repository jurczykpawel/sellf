...
ALTER TABLE public.products DROP CONSTRAINT IF EXISTS products_custom_price_min_check;
ALTER TABLE public.products ADD CONSTRAINT products_custom_price_min_check CHECK (custom_price_min >= 0);

-- NOTE: PWYW-free grant path is now unified into public.grant_free_product_access
