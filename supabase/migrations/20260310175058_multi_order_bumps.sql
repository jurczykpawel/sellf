...
CREATE INDEX idx_payment_line_items_order_bump ON public.payment_line_items(order_bump_id) WHERE order_bump_id IS NOT NULL;
...
REVOKE ALL ON public.payment_line_items FROM anon, authenticated;
