...
export function SubscriptionSection({ formData, setFormData, t }: SectionProps) {
  ...
  return (
    <ModalSection title={t('subscription.title', { defaultValue: 'Subscription' })}>
      <p className="text-xs text-sf-muted mb-3">
        {t('subscription.help', {
          defaultValue:
            'Subscription products bill on a recurring schedule. Set the recurring price, billing interval, and optional trial below.',
        })}
      </p>
