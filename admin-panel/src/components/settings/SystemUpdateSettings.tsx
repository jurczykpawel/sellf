...
export default function SystemUpdateSettings() {
 ...
 <p data-testid="current-version" className="text-lg font-mono text-gf-heading">
 v{currentVersion}
 </p>
 </div>
 ...
 disabled={isChecking}
 className="px-4 py-2 text-sm font-medium text-gf-accent border border-gf-accent/30 hover:bg-gf-accent/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 <div className="flex items-center gap-2 p-3 bg-gf-success-soft border border-gf-success/20">
 <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
 <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" />
 </svg>
 <p className="text-sm text-gf-success">{t('settings.upToDate')}</p>
 </div>
 )}

 {updateInfo?.update_available && (
 <div className="flex items-center justify-between p-3 bg-gf-accent-soft border border-gf-accent/20">
