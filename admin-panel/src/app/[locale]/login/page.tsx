...
export default function LoginPage() {
    ...
    return (
      <div className="min-h-screen bg-gf-deep flex items-center justify-center">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gf-raised/40 backdrop-blur-sm rounded-2xl mb-4">
            <svg className="w-8 h-8 text-gf-heading animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
            </svg>
          </div>
          <p className="text-gf-heading text-lg">{t('common.loading')}</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gf-deep flex items-center justify-center p-4">
      {/* CSS Animations */}
      <style jsx>{`
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gf-raised/40 backdrop-blur-sm rounded-2xl mb-4">
            <svg className="w-8 h-8 text-gf-heading" fill="none" stroke="currentColor" viewBox="0 0 24 24">
